...
# I have specified it here mam.
df_adm_notes_clean['DATE_DIFF'] = (df_adm_notes_clean['NEXT_ADM_DATE'] - df_adm_notes_clean['ADMITTIME']).dt.days

conditions = [    df_adm_notes_clean['DATE_DIFF'] <= 3,
    (df_adm_notes_clean['DATE_DIFF'] >= 4) & (df_adm_notes_clean['DATE_DIFF'] <= 7),
    (df_adm_notes_clean['DATE_DIFF'] >= 8) & (df_adm_notes_clean['DATE_DIFF'] <= 15),
    (df_adm_notes_clean['DATE_DIFF'] >= 16) & (df_adm_notes_clean['DATE_DIFF'] <= 30),
    df_adm_notes_clean['DATE_DIFF'] > 30
]

choices = [4, 3, 2, 1, 0]

df_adm_notes_clean['OUTPUT_LABEL'] = np.select(conditions, choices, default=np.nan)
